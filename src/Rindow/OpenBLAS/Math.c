...
#define RINDOW_OPENBLAS_MATH_GET_INTEGER_TEMPLATE(data_type) { \
    data_type *x = &(((data_type *)buffer)[offset]); \
    return (zend_long)(x[index*incWidth]);  \
}

static zend_long rindow_openblas_math_get_integer(
    zend_long dtype,void *buffer, zend_long offset,zend_long incWidth,
    zend_long index)
{
    switch (dtype) {
        case php_rindow_openblas_dtype_int8:
            RINDOW_OPENBLAS_MATH_GET_INTEGER_TEMPLATE(int8_t);
        case php_rindow_openblas_dtype_uint8:
            RINDOW_OPENBLAS_MATH_GET_INTEGER_TEMPLATE(uint8_t);
        case php_rindow_openblas_dtype_int16:
            RINDOW_OPENBLAS_MATH_GET_INTEGER_TEMPLATE(int16_t);
        case php_rindow_openblas_dtype_uint16:
            RINDOW_OPENBLAS_MATH_GET_INTEGER_TEMPLATE(uint16_t);
        case php_rindow_openblas_dtype_int32:
            RINDOW_OPENBLAS_MATH_GET_INTEGER_TEMPLATE(int32_t);
        case php_rindow_openblas_dtype_uint32:
            RINDOW_OPENBLAS_MATH_GET_INTEGER_TEMPLATE(uint32_t);
        case php_rindow_openblas_dtype_int64:
            RINDOW_OPENBLAS_MATH_GET_INTEGER_TEMPLATE(int64_t);
        case php_rindow_openblas_dtype_uint64:
            RINDOW_OPENBLAS_MATH_GET_INTEGER_TEMPLATE(uint64_t);
        case php_rindow_openblas_dtype_float32:
            RINDOW_OPENBLAS_MATH_GET_INTEGER_TEMPLATE(float);
        case php_rindow_openblas_dtype_float64:
            RINDOW_OPENBLAS_MATH_GET_INTEGER_TEMPLATE(double);
        default:
            return -1;
    }
}
        ...
        case php_rindow_openblas_dtype_float32:
            {
                ...
                for(i=0; i<m; i++) {
                    selector = rindow_openblas_math_get_integer(
